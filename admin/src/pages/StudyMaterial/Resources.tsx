...
function StudyMaterialResource() {
    ...
    return (
        <div className="w-full">
            <div className="flex justify-end">
                <Button onClick={() => setUploadModel(true)}>Upload Study Material</Button>
            </div>
            ...
            {isUploadModel && <div className="absolute w-[80%] h-5/6 bg-white bottom-0 left-[20%] rounded-t-3xl shadow-[0px_-4px_8px_rgba(17,17,26,0.2)] pt-4">
                <div className="w-1/2 mx-auto">
                    ...
                    <div className="my-2 mt-6">
                        <Input name="material-title" label="Study Material Title" inputRef={titleRef} />
                    </div>
                    <div className="my-4">
                        <Input name="video-file" label="Select PDF" type="file" inputRef={fileRef} />
                    </div>
...
export default StudyMaterialResource
