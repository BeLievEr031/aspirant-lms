...
import { useStudyPlanExamQuery } from "../../store/pages/StudyPlan/useStudyPlan";
// const EXAM_CATEGORY = [
...
const StudyPlanExamCategory = memo(() => {
    ...
    const { isPending, isError, error, data } = useStudyPlanExamQuery(pagination);
    if (isPending) {
...
export default StudyPlanExamCategory